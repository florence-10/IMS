...
class billClass:
    def __init__(self, root):
        ...
        lbl_search=Label(ProductFrame2,text="Product Name",font=("times now roman",15,"bold"),bg="white").place(x=2,y=45)
        txt_search=Entry(ProductFrame2,textvariable=self.var_search,font=("times now roman",15,),bg="lightyellow").place(x=145,y=47,width=140,height=22)
        ...
        lbl_not=Label(ProductFrame1,text="Note:'Enter 0 Quantity to remove product from the Cart'",font=("goudy old style",12),anchor='w',bg="white",fg="red").pack(side=BOTTOM,fill=X)
        ...
        lbl_name=Label(CustomerFrame,text="Name",font=("times now roman",15),bg="white").place(x=5,y=35)
        txt_name=Entry(CustomerFrame,textvariable=self.var_cname,font=("times now roman",13,),bg="lightyellow").place(x=80,y=35,width=180)
        
        lbl_contact=Label(CustomerFrame,text="Contact No.",font=("times now roman",15),bg="white").place(x=270,y=35)
        txt_contact=Entry(CustomerFrame,textvariable=self.var_contact,font=("times now roman",13,),bg="lightyellow").place(x=380,y=35,width=140)
        ...
        lbl_p_name=Label(Add_CartWidgetFrame,text="Product Name",font=("times now roman",15),bg="white").place(x=5,y=5)
        txt_p_name=Entry(Add_CartWidgetFrame,textvariable= self.var_pname,font=("times now roman",15),bg="lightyellow",state='readonly').place(x=5,y=35,width=190,height=22)

        lbl_p_price=Label(Add_CartWidgetFrame,text="Price Per Qty",font=("times now roman",15),bg="white").place(x=230,y=5)
        txt_p_price=Entry(Add_CartWidgetFrame,textvariable= self.var_price,font=("times now roman",15),bg="lightyellow",state='readonly').place(x=230,y=35,width=150,height=22)

        lbl_p_qty=Label(Add_CartWidgetFrame,text="Quantity",font=("times now roman",15),bg="white").place(x=390,y=5)
        txt_p_qty=Entry(Add_CartWidgetFrame,textvariable= self.var_qty,font=("times now roman",15),bg="lightyellow").place(x=390,y=35,width=120,height=22)

        self.lbl_inStock=Label(Add_CartWidgetFrame,text="In Stock",font=("times now roman",15),bg="white")
        self.lbl_inStock.place(x=5,y=70)
        
        btn_clear_cart=Button(Add_CartWidgetFrame,text="Clear",command=self.clear_cart,font=("times now roman",15,"bold"),bg="lightgray",cursor="hand2").place(x=180,y=70,width=150,height=30)
        btn_add_cart=Button(Add_CartWidgetFrame,text="Add | Update Cart",command=self.add_update_cart,font=("times now roman",15,"bold"),bg="orange",cursor="hand2").place(x=340,y=70,width=180,height=30)
